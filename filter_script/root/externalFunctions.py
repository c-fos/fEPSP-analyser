...
######################
"""
This sources were got from different places of internet.
    iswt were got from PyWavelets google groups. author:Michael Marino
    extrema were got from http://mail.scipy.org/pipermail/scipy-user/2008-October/018318.html.\
        author:  iCy-fLaME
    smooth were got from http://www.scipy.org/Cookbook/SignalSmooth
"""
import pywt
from numpy import arange,zeros,math, r_,convolve, ones,roll,diff,sign,nonzero,hanning, hamming, bartlett, blackman
